...
//   const visibleInventories = item.inStock.slice(0, MAX_VISIBLE_INVENTORIES);
//   const extraCount = item.inStock.length - MAX_VISIBLE_INVENTORIES;
...
//   function renderRow(rowItem, rowChecked, rowToggle, isDupChild = false) {
//     const isRed = isDupChild;
//     const rowStyle = isDupChild ? redBorderStyle : {};
//     return (
//       <>
//         <tr className="relative" style={rowStyle}>
//           <td
...
//               <tr key={dupItem.id} className="relative" style={redBorderStyle}>
//                 <td
//                   className={`${tdBase} ${tdPadY} pl-8 pr-[10px]`}
//                   style={{ minWidth: "62px", height: "72px" }}
//                 >
//                   <label
//                     className="relative block cursor-pointer select-none"
//                     style={{ paddingLeft: "20px", marginBottom: "12px" }}
