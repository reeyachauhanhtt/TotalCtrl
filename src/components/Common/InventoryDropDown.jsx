...
export default function InventoryDropdown({
  ...
  function InventoryItem({ inv }) {
    ...
    return (
      <div
        ...
        className={`px-8 py-4 text-sm cursor-default flex justify-between items-center hover:bg-gray-50 ${
  ...
  return (
    <div className='relative' ref={wrapperRef}>
      {/* INPUT + DROPDOWN */}
      <div
        className={`flex items-center gap-2 rounded-sm w-80 h-10 px-3 py-1.5 text-xs text-gray-700 transition cursor-default ${
          open
      ...
      >
        <input
          ...
          className={`flex-1 bg-transparent outline-none text-sm text-gray-700 placeholder-gray-600 ${
            open ? 'cursor-text' : 'cursor-default'
          }`}
        />
