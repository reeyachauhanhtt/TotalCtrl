  ...
  if (asTr) {
    return (
      <tr style={{ borderTop: '1px solid rgb(230,230,237)' }}>
        ...
        >
          <Skeleton baseColor='#ebebeb' highlightColor='#d4d4d8' height={14} />
        </td>

        <td style={{ paddingTop: 22, paddingBottom: 22, paddingRight: 16 }}>
          <Skeleton baseColor='#ebebeb' highlightColor='#d4d4d8' height={12} />
        </td>
...
export function InternalOrderDetailSkeleton() {
  return (
    <div className='flex flex-col flex-1 h-full overflow-hidden'>
      <div className='flex-1 overflow-auto'>
        {/* Order info */}
        <div style={{ width: '95%', margin: '40px auto 24px' }}>
          ...
          {/* Order number */}
          <div className='mb-6'>
            <SkeletonBar style={{ height: 12, width: 120, borderRadius: 8 }} />
          </div>
            ...
            {[120, 140, 60].map((w, i) => (
              <div
                ...
                style={{
                  ...
                  borderRight: i < 2 ? '1px solid #d7d7db' : 'none',
                  paddingLeft: i > 0 ? 24 : 0,
                }}
              >
                <SkeletonBar
          ...
          <tbody>
            {Array.from({ length: 3 }).map((_, i) => (
              <tr key={i} style={{ borderBottom: '1px solid #e6e6ed' }}>
                ...
                <td style={{ padding: '22px 0', width: '50%' }}>
                  <SkeletonBar style={{ height: 12, width: 400 }} />
                </td>
                <td style={{ padding: '22px 0', width: '20%' }}>
                  <SkeletonBar
                    style={{ height: 12, width: 80, marginLeft: 'auto' }}
