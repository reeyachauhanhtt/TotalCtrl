...
//       <button
//         onClick={handleOpen}
//         className='flex items-center justify-between h-9 text-[12px] text-[#19191c] font-normal cursor-pointer rounded-sm px-3 bg-white'
    ...
    <div className='relative' ref={containerRef}>
      ...
      {open && (
        <div
          ...
          style={{ top: 'calc(100% + 4px)', width: 700 }}
        >
          <DateRangePicker
            ranges={pendingRange}
            onChange={(item) => setPendingRange([item.selection])}
